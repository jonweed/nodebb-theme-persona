	...
	"use strict";
		...
		$.extend( Plugin.prototype, {
			...
			onResize: function() {
				...
				_hideNavScrollTop=scrollTop + _elementHeight;
				_showNavScrollTop=scrollTop - _elementHeight;
			},
			...
			if (!_disabled) {
				...
				if (scrollDelta < 0) {
					_hideNavScrollTop=scrollTop +_elementHeight; // + _elementHeight;
					...
					_showNavScrollTop=scrollTop -_elementHeight; // - _elementHeight;
