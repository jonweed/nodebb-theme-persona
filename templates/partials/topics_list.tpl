...
<ul component="category" class="topic-list" itemscope itemtype="http://www.schema.org/ItemList" data-nextstart="{nextStart}" data-set="{set}">
	...
	<li component="category/topic" class="category-item ro-category-item {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
		...
		<div class="ro-teaser teaser hidden-xs" component="topic/teaser" style="border-color: {topics.category.bgColor}">
			<div class="ro-card">
				<!-- IF topics.unreplied -->
				<p>
					[[category:no_replies]]
				...
				<p>
					<a href="{config.relative_path}/user/{topics.teaser.user.userslug}">
						...
						<!-- ELSE -->
						<span title="{topics.teaser.user.username}" class="ro-user-icon" style="background: {topics.teaser.user.icon:bgColorImage};">{topics.teaser.user.icon:text}</span>
						<!-- ENDIF topics.teaser.user.picture -->
					</a>
